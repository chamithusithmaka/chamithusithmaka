...
<br/>
<img src="https://komarev.com/ghpvc/?username=chamithusithmaka&label=Profile%20Views&color=6366f1&style=for-the-badge" alt="Profile Views" />
&nbsp;
<a href="https://github.com/chamithusithmaka?tab=followers">
  <img src="https://img.shields.io/github/followers/chamithusithmaka?label=Followers&style=for-the-badge&color=7c3aed&labelColor=0d1117" alt="GitHub Followers"/>
</a>
&nbsp;
<img src="https://img.shields.io/github/stars/chamithusithmaka?label=Total%20Stars&style=for-the-badge&color=a855f7&labelColor=0d1117" alt="GitHub Stars"/>
...
experience:
  - Software Engineer Intern @ SLIIT Gen AI Team
  - Software Engineer Intern @ NWSDB
currently_learning:
...
- Built AI chatbots for Business, Psychology & Computing faculties
- Integrated **ElevenLabs** API for voice synthesis
- Applied advanced **prompt engineering** techniques
- Developed backends with **Flask** & **TypeScript/Express.js**
- Managed **PostgreSQL** databases & deployed on **Replit**
...
- Designed & implemented Water Quality Management features
- Developed **RESTful APIs** for water testing data
- Built responsive dashboards with **React**
- Implemented database schemas with **SQL Server** & **Sequelize**
- Collaborated on enterprise **ERP architecture**
...
`React Native` `Node.js` `MongoDB` `Gemini API`  
`OpenRouter (GPT-4o-mini)` `Jira`
...
`AI Recommendations` `Material Design`
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/chamithusithmaka/chamithusithmaka/output/github-snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/chamithusithmaka/chamithusithmaka/output/github-snake.svg" />
    <img alt="github contribution snake animation" src="https://raw.githubusercontent.com/chamithusithmaka/chamithusithmaka/output/github-snake-dark.svg" />
  </picture>
</div>
